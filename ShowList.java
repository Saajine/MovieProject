...
public class ShowList extends ItemList<Show, String> {
	...
	/**
	 *	Takes a calendar object as input, then runs through each show in showList using an iterator
	 *	and checks to see if the date is within the start and end dates of any of the shows
	 *	If it finds a show for which the date passed is in between the start and end date, it returns
	 *	that show, otherwise if it goes through all shows without finding one, it returns null
	 */
