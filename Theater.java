...
public class Theater implements Serializable{
	...
	/**
	 * returns the balance for the given clientID
	 * @param client clientID of tehy client
	 * @return string representation of client's balance
	 */
	public String clientBalance(String clientID){
		Client client = clientList.search(clientID);	
		double balance = client.getBalance();
		String output =  "Client balance is " + balance;
		return output;
	}
	 ...
	 */
	public boolean payClient(String clientID, double payAmount){
		Client client = clientList.search(clientID);
	...
	/**
	 * Returns a string representation of all tickets in ticketList
	 * @return	A string representation of all tickets in ticketList
	 */
	...
	/**
	 *	Takes the necessary inputs for the constructor for a ticket object and the quantity as parameters, then performs a series of checks
	 *	to ensure that the ticket(s) being purchased are for a valid show, customer, and credit card belonging to that customer
	 *	If anything passed to this method is not valid, it returns false. Otherwise, for the number of tickets requested, it instantiates each
	 *	one, adds it to ticketList and to the respective customer, then calculates the total balance to be paid to the client who is running the
	 *	show for which the tickets have been purchased and adds the balance to that client
	 */
