...
public class UserInterface implements Serializable{
	  ...
	  public void addCustomer() {
	    ...
	    if (result == null) {
	      System.out.println("Could not add customer due to duplicate credit card");
	    }
	    else{
	  ...
	  */
	  ...
	  /**
	   *	Prompts the user for the necessary information, then passes the information to the theater object to instantiate
	   *	a number of new tickets equal to the quantity given the information provided
	   *	If the tickets purchased were student tickets, it notifies the user that a student ID will be required the day of the show
	   */
	  public void purchaseTickets(int type) {
		  ...
		  if (type == Theater.STUDENT_TICKET) {
			  System.out.println("NOTICE: Student ID will need to be shown on day of show for each student advance ticket purchased");
		  }
	  ...
	  /**
	   *	Calls the appropriate method in theater, then prints out a string representation
	   *	of all tickets in ticketList in the theater object
	   */
	  ...
	  public void payClient(){
		...
		String clientID = getToken("Enter client ID");
		boolean result = theater.checkClient(clientID);
		if (result == false){
			System.out.println("No such client");
			return;
		}
		else{
			System.out.println(theater.clientBalance(clientID));
			double payAmount = Double.parseDouble(getToken("Enter required amount"));
			boolean output = theater.payClient(clientID, payAmount);
			if (output == true) {
